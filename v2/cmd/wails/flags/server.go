...
func (b *ServerBuild) Default() *ServerBuild {
...
func (b *ServerBuild) GetBuildMode() build.Mode {
	if b.Debug {
		return build.Debug
	}
...
func (b *ServerBuild) GetWebView2Strategy() string {
	return b.wv2rtstrategy
}

func (b *ServerBuild) GetTargets() *slicer.StringSlicer {
...
func (b *ServerBuild) GetCompilerPath() string {
	return b.compilerPath
}

func (b *ServerBuild) GetTags() []string {
	return b.userTags
}

func (b *ServerBuild) Process() error {
	...
	if _, _, err := net.SplitHostPort(b.DevServer); err != nil {
		return fmt.Errorf("DevServer is not of the form 'host:port', please check your wails.json")
	}

	b.devServerURL, err = url.Parse("http://" + b.DevServer)
	if err != nil {
		return err
	}
...
func (b *ServerBuild) GetBuildModeAsString() string {
	if b.Debug {
		return "debug"
	}
	return "production"
...
func (b *ServerBuild) GetDefaultArch() string {
