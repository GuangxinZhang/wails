...
import (
	...
	"github.com/wailsapp/wails/v2/internal/frontend/serserver"
...
func CreateApp(appoptions *options.App) (*App, error) {
	...
	if devServer == "" {
		devServer = "0.0.0.0:34115"
	}
	log.Println("server = ", devServer)
	...
	desktopFrontend := desktop.NewServerFrontend(ctx, appoptions, myLogger, appBindings, messageDispatcher)
	appFrontend := serserver.NewFrontend(ctx, appoptions, myLogger, appBindings, messageDispatcher, desktopFrontend)
